...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-root text-primary selection:bg-accent-blue selection:text-ocean-900 font-sans">
      
      {/* Navigation */}
      <nav className="flex justify-between items-center p-6 lg:px-12 backdrop-blur-md bg-root/50 fixed w-full z-50 border-b border-subtle">
      ...
      <header id="home" className="relative pt-40 pb-20 px-6 lg:px-12 flex flex-col items-center text-center overflow-hidden">
         ...
         <motion.p 
            ...
            className="mt-8 text-xl text-muted max-w-2xl z-10 font-medium"
         >
         ...
         >
            <div onClick={() => alert("Takes user to Google Play Listing")} className="flex items-center gap-3 bg-deep/40 border border-subtle px-6 py-3 rounded-xl cursor-pointer hover:border-accent-blue/50 transition shadow-lg">
               ...
               <div className="text-left text-primary"><p className="text-[10px] leading-tight font-medium text-muted">GET IT ON</p><p className="font-black text-sm leading-tight tracking-wide">Google Play</p></div>
            </div>
            <div onClick={() => alert("Takes user to iOS App Store")} className="flex items-center gap-3 bg-deep/40 border border-subtle px-6 py-3 rounded-xl cursor-pointer hover:border-accent-blue/50 transition shadow-lg">
               ...
               <div className="text-left text-primary"><p className="text-[10px] leading-tight font-medium text-muted">Download on the</p><p className="font-black text-sm leading-tight tracking-wide">App Store</p></div>
            </div>
         </motion.div>
      </header>

      {/* About Section */}
      <section id="about" className="py-24 px-6 lg:px-12 bg-panel relative z-10 border-t border-subtle">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="flex-1">
                 ...
                 <p className="text-muted text-lg leading-relaxed mb-6 font-medium">
                    <strong className="text-primary">Samudra Sutra</strong> was born from a singular idea: 80% of ocean plastic actually originates from land-based inland river networks. If we can target and clean local municipal drains like the Vrishabhavathi River before they flow outwards, we save the ocean.
                 </p>
              ...
              <div className="flex-1 w-full bg-panel p-8 rounded-3xl border border-subtle shadow-2xl relative">
                  ...
                  <div className="flex flex-col gap-6">
                      <div className="flex items-center gap-4">
                         ...
                         <h3 className="font-bold text-primary uppercase tracking-widest text-sm">Citizen Intel Network</h3>
                      </div>
                      <div className="flex items-center gap-4">
                         ...
                         <h3 className="font-bold text-primary uppercase tracking-widest text-sm">Government Auth Dashboard</h3>
                      </div>
                      <div className="flex items-center gap-4">
                         ...
                         <h3 className="font-bold text-primary uppercase tracking-widest text-sm">Corporate Sponsoring</h3>
                      </div>
                  </div>
              </div>
          </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-24 px-6 lg:px-12 bg-white/5 border-t border-subtle">
         <div className="max-w-7xl mx-auto">
             <div className="text-center mb-16">
                 <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Unprecedented Verification</h2>
                 <p className="text-muted text-lg">Next-gen tracking architecture for a cleaner tomorrow.</p>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {[
                    ...
                    <motion.div 
                        key={i}
                        whileHover={{ y: -10 }}
                        className="bg-panel/50 border border-subtle p-8 rounded-3xl hover:border-accent-blue/50 transition-colors backdrop-blur-md"
                    >
      ...
      {/* How it works */}
      <section className="py-24 px-6 lg:px-12 bg-root border-t border-subtle relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row gap-8 w-full justify-between relative">
                 ...
                 {["Capture Waste", "AI Verifies", "Uploads Stream", "Earn Credits"].map((step, i) => (
                    <div key={i} className="flex flex-col items-center z-10 relative">
                        <div className="w-16 h-16 bg-root border-2 border-accent-blue rounded-full flex items-center justify-center text-2xl font-black mb-4 shadow-[0_0_20px_rgba(79,172,254,0.4)]">
                           {i + 1}
                        </div>
       ...
       {/* Footer */}
       <footer className="py-12 border-t border-subtle px-6 lg:px-12 text-center text-muted-dark text-sm bg-deep/20">
